	...
	if(user_answer2==main_answer2):
		if(user_answer1==main_answer1):
			if(user_answer3==main_answer3):
				messagebox.showinfo("Well Done",'You have a Right Answer and You Unlock Next Level')
...
label_e1=Label(OperationFrame1,text="C _ _ E")
label_e1.pack()
...
label_e2=Label(OperationFrame1,text="B _ _ L _ _ N _ ")
label_e2.pack()
...
label_e3=Label(OperationFrame1,text="_ I N _ ")
label_e3.pack()
...
lb2=Label(frame1,text="   Level 3  ",font=('Arial 20'))
lb2.pack()
lb2.place(x=550,y=365)



ph = Image.open('crossword3.jpeg')
