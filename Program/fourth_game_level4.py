...
def next_level_with_right():
	import os
	os.system('python fourth_game_level5.py')
	quit()

def ans_check():
	user_answer1=e1.get()
	main_answer1='sunglasses'
	user_answer2=e2.get()
	main_answer2='scarf'
	user_answer3=e3.get()
	main_answer3='camera'
...
def hint():
	import os
	os.system('python hint_crossword_level4.py')
...
e1.pack()
e1.place(height=40,width=300,x=480,y=350)
label_e1=Label(root,text="S _ N _ L _ S _ _ S")
label_e1.pack()
label_e1.place(x=480,y=330)

e2=Entry(root,justify='center',font=('Arial',20))
e2.pack()
e2.place(height=40,width=300,x=480,y=420)
label_e2=Label(root,text="S _ _ R _")
label_e2.pack()
label_e2.place(x=480,y=400)

e3=Entry(root,justify='center',font=('Arial',20))
e3.pack()
e3.place(height=40,width=300,x=480,y=490)
label_e3=Label(root,text="C _ M _ R _")
label_e3.pack()
label_e3.place(x=480,y=470)
...
ph = Image.open('../image/crossword4.jpeg')
