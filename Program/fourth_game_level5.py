...
label_e1=Label(root,text=" A L _ _ M C _ _ C _ ")
label_e1.pack()
...
label_e2=Label(root,text="_ _ I _ T _ _ G")
label_e2.pack()
...
label_e3=Label(root,text="_ O _ _ S")
label_e3.pack()
...
ph = Image.open('../image/crossword5.jpeg')
