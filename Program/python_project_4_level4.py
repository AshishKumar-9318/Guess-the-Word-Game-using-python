...
label_e1=Label(OperationFrame1,text="S _ N _ L _ S _ _ S")
label_e1.pack()
...
label_e2=Label(OperationFrame1,text="S _ _ R _")
label_e2.pack()
...
label_e3=Label(OperationFrame1,text="C _ M _ R _")
label_e3.pack()
