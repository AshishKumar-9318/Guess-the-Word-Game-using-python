...
def next_level_with_right():
	import os
	os.system('python python_project_4_level2.py')
	quit()
...
def ans_check():
	...
	if(user_answer2==main_answer2):
		if(user_answer1==main_answer1):
			...
			Button(root,text="      Next      ",font=('Arial',20),command=next_level_with_right).place(x=130,y=180)
			clear()
			hint()
		else:
...
ph_submit = Image.open('submit.png')
