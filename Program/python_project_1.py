...
answer=["apple","banana","grapes","oranges","lime","lemon","cherry","blueberry","watermelon","peach","pineapple","strawberry",
    "coconut","pear","apricot","avocado","blackberry","grapefruit","kiwi","mango","plum","raspberry","pomegranate","papaya","litchi"]
