...
def next_level_with_right():
	import os
	os.system('python fourth_game_level4.py')
	quit()
...
def hint():
	import os
	os.system('python hint_crossword_level3.py')
...
label_e1=Label(root,text="C _ _ E")
label_e1.pack()
...
label_e2=Label(root,text="B _ _ L _ _ N _ ")
label_e2.pack()
...
label_e3=Label(root,text="_ I N _ ")
label_e3.pack()
...
ph = Image.open('../image/crossword3.jpeg')
